 ...
 *
 * 2graymap.h - just a couple of functions, possibly will be bigger later
 *
...
/* Currently there is no special Graymap class.
 * After all, the library is targetted at bitonal images.
 */
